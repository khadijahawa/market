        ...
        <div className="container">
            <div className="wallet-inner">
                <div className="wallet-title text-center">
                    ...
                    <p className="m-auto mb-5">Connect with one of available wallet providers</p>
                </div>
                ...
                <ul className="nav justify-content-center nav-pills wallet-tab-list" id="pills-tab" role="tablist">
                    ...
                    <li className="nav-item" role="presentation">
                        <div className="nav-link wallet-tab" id="wallet-tab-2" data-bs-toggle="pill"
                            ...
                            aria-selected="false">
                            <img src="assets/images/wallet/1.png" alt="ud" /><span>Unstoppable</span>
                        </div>
                    </li>
                    </ul>
                ...
                <div className="tab-content" id="pills-tabContent">
                    ...
                    <div className="tab-pane fade" id="pills-wallet-2" role="tabpanel" aria-labelledby="wallet-tab-2">
                        <div className="wallet-content">
                            <div className="wallet-img">
                                <img src="assets/images/wallet/channels4_profile.jpg" alt="Wallet Name" />
                            </div>
                            <div className="wallet-desc">
                                <h5>Connect Your Unstoppable Domain</h5>
                                 <LoginUD />
                                <a href="https://unstoppabledomains.com/?ref=e904125842e0429" target="_blank" rel="noopener noreferrer">Learn more about Unstoppable Domains
                                </a>
                            </div>
                        </div>
                    </div>
